...
class MainLinksListFiles extends BooleanSetting {
	...
	public function getLabelMessageKey() {
		return 'bs-discovery-config-mainlinks-listfiles-label';
	}
	...
	public function getHelpMessageKey() {
		return 'bs-discovery-config-mainlinks-listfiles-help';
	}
