...
class MainLinksCategories extends BooleanSetting {
	...
	public function getLabelMessageKey() {
		return 'bs-discovery-config-mainlinks-categories-label';
	}
	...
	public function getHelpMessageKey() {
		return 'bs-discovery-config-mainlinks-categories-help';
	}
